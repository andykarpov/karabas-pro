...
#define ZX_MATRIX_FULL_SIZE 72 // 40 keys + bit6 + reset + turbo + magic + keyboard is_up + wait + sw1 + sw2 + 9 bit scancode + sw3 + sw4 + sw5 + kb_mode + sw6 + sw7 + sw8 + sw9 + sw10 + 000000
